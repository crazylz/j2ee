      ...
      <el-container>
        ...
        <el-container>
          ...
          <el-footer>
            ...
            >法律声明及隐私权政策</label>
            <label style="color: #969696;margin-right:30px" @click="reportDialogVisible=true;getReportHtml()">廉政举报</label>
            <label
              style="color: #969696;margin-right:30px"
...
export default {
  ...
  methods: {
    ...
    getReportHtml(){
      var res = this.$axios.get('http://localhost:8080/static/reportDialog.html');
      res.then(data => {
        log.console('获取数据');
        reporthtml = data
      })
